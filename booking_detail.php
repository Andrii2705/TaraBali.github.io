	...
	<div class="user_profile_info">	
        ...
        <form method="post" name="sewa" onSubmit="return valid();"> 
			...
			<label>Kode Sewa</label>
				<input type="text" class="form-control" name="kode" value="<?php echo $kode['kode'];?>"readonly>
            </div>
			<input type="hidden" class="form-control" name="vid"  value="<?php echo $vid[''];?>"required>
            <div class="form-group">
			<label>Baju</label>
				<input type="text" class="form-control" name="baju" value="<?php echo $result['nama_baju'];?>"readonly>
            </div>
            <div class="form-group">
			...
			<?php if($result['status']=="Menunggu Pembayaran"){
				...
				?>
			<b>*Silahkan transfer total biaya sewa maksimal tanggal <?php echo IndonesiaTgl($tglhasil);?>.
			<?php
			}else{
