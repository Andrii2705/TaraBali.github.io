...
if(strlen($_SESSION['ulogin'])==0){ 
	...
	if(isset($_POST['submit'])){
		...
		//$sql 	= "SELECT booking.*,baju.*, jenis.* FROM booking, baju, jenis WHERE booking.id_baju=baju.id_baju
		...
		?>
			...
			<div class="col-md-6 col-sm-8">
				  ...
				  <div class="product-listing-content">
					...
					<p class="list-price"><?php echo htmlentities(format_rupiah($result['harga']));?> /2 Hari</p>
				  </div>	
			</div>
