    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-3">
          <div class="logo"><a href="index.php"><img src="admin/img/icon.jpeg" width="70px" height="70px" alt="image"/></a> </div>
        </div>
        <div class="col-sm-8 col-md-8">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="https://instagram.com/tara_baliwedding?igshid=ZjE2NGZiNDQ=">@tara_baliwedding</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Telp : </p>
              <a href="https://wa.me/message/LHYAGMFSI6YHJ1">+62 812-3742-0368</a> </div>
	 ...
	 <i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown"  bgcolor="blue"> <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Make Up</a>
			<ul class="dropdown-menu">
				<li><a href="bajuanakp.php">Perempuan</a></li>
				<li><a href="bajuanakl.php">Laki-Laki</a></li>
			</ul>
          </li>
          <li class="dropdown"  bgcolor="blue"> <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sewa Baju</a>
			<ul class="dropdown-menu">
