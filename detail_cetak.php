...
<head>
	...
	<meta name="description" content="Penyewaan Baju">
	<meta name="author" content="">

	<title>Cetak Detail Sewa</title>

	<link href="admin/img/fav.jpeg" rel="icon" type="images/x-icon">
	...
	<![endif]-->
	<script src="file://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
	<script src="file://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min.js"></script>
</head>
				...
				<tbody>
					<tr>
						<td rowspan="3" width="16%" class="text-center">
							<img src="admin/img/icon.jpeg" alt="logo-dkm" width="80" />
						</td>
						<td class="text-center"><h3>Tara Bali</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center">Phone : +62 823-2275-3411 | Instagran @tara_baliwedding</td>
					</tr>
					<tr>
